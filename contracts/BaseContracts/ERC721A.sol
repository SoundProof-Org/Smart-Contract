...
abstract contract ERC721A is Context, ERC165, IERC721 {
    ...
    /**
     * @dev Safe Transfer NFT - See {IERC721-safeTransfer}.
     */
    ...
    /**
     * @dev Burn NFT - See {IERC721-Burn}
     */
    function burn(uint256 tokenId) public override {
        address owner = ERC721A.ownerOf(tokenId);
        require(owner == _msgSender(), "ERC721: Owner and msgSender should be same");
     ...
     *
     * - `tokenId` must exist.
     * - `owner` must be exist and should be owner of `tokenId`
     *
     * Emits a {Transfer} event.
     */
